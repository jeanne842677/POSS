		...
		<div class="under_wrap">
			...
			<div class="center_wrap">
				<div class="table_wrap">
					<div class="drag" id ="drag1" style="
							height: ${height};
							top : ${top} ;
							left : ${left }
						">안녕!! 드래그 </div>
					<div class="drag" id="drag2">안녕!! 드래그</div>
...
document.querySelector('#save_btn').addEventListener('click' , e=> {
	...
	document.querySelectorAll(".drag").forEach((div,i)=> {
		
		
		let DWidth = div.offsetWidth;
		let DHeight = div.offsetHeight;
		let DTop = div.offsetTop;
		let DLeft = div.offsetLeft;
