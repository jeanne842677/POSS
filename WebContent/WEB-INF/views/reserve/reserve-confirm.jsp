...
<script defer type="text/javascript" src="/resources/js/reserve/reserve-confirm.js"></script>    
...
<div class="section-wrap">
    <section id="title_area">
        ...
        <div class="setting" ><i class="fas fa-cog" type="button" onclick="location.href='/reserve/modify'"></i></div>
                      ...
                      <tr>
                        ...
                        <c:choose>
                          <c:when test="${rl.isCancel eq 0 and rl.isVisit eq 0}">
                           ...
                           <c:otherwise>
                              <td><button type='button' id='btn-table' class="btn btn-secondary disabled">예약취소</button></td>
                           </c:otherwise>
                        </c:choose>
                      </tr>
                   </c:forEach>
